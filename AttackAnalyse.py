...
## print informations
def printer(data):
        print(timestampConverter(data.tm)),
        print(" "),
        sys.stdout.write(data.addr),
        print(" Attack :["),
        sys.stdout.write(attack[data.spc_rslt][0]),
        print("] Categ. :["),
        sys.stdout.write(attack_categroy[data.cat_rslt][1]),
        print("] MODBUS Func. :["),
        sys.stdout.write(modbus_func(data.func)),
        print("] Sys. Mode :["),
        sys.stdout.write(system_mode(data.sys_mode)),
        print("] Control Scheme :["),
        sys.stdout.write(control_scheme(data.ctr_schm)),
        print("] Pump :["),
        sys.stdout.write(pump(data.pmp)),
        print("] Solenoid :["),
        sys.stdout.write(solenoid(data.solenoid)),
        print("] Command :["),
        sys.stdout.write(command(data.cmd_res)),
        print("]")
...
def statistic_printer():
        print("---------------------------------------------------------")
        print("  Setpoint Attacks \t\t: "),
        print("%5s" % attack_stat[0]),
        print("\t"),
        print("%.2f " % (float(attack_stat[0])/total_counter*100)),
        print("%")
        print("  PID Gain Attacks \t\t: "),
        print("%5s" % attack_stat[1]),
        print("\t"),
        print("%.2f " % (float(attack_stat[1])/total_counter*100)),
        print("%")
        print("  PID Reset Rate Attacks \t: "),
        print("%5s" % attack_stat[2]),
        print("\t"),
        print("%.2f " % (float(attack_stat[2])/total_counter*100)),
        print("%")
        print("  PID Rate Attacks \t\t: "),
        print("%5s" % attack_stat[3]),
        print("\t"),
        print("%.2f " % (float(attack_stat[3])/total_counter*100)),
        print("%")
        print("  PID Deadband Attacks \t\t: "),
        print("%5s" % attack_stat[4]),
        print("\t"),
        print("%.2f " % (float(attack_stat[4])/total_counter*100)),
        print("%")
        print("  PID Cycle Time Attacks \t: "),
        print("%5s" % attack_stat[5]),
        print("\t"),
        print("%.2f " % (float(attack_stat[5])/total_counter*100)),
        print("%")
        print("  Pump Attack \t\t\t: "),
        print("%5s" % attack_stat[6]),
        print("\t"),
        print("%.2f " % (float(attack_stat[6])/total_counter*100)),
        print("%")
        print("  Solenoid Attack \t\t: "),
        print("%5s" % attack_stat[7]),
        print("\t"),
        print("%.2f " % (float(attack_stat[7])/total_counter*100)),
        print("%")
        print("  System Mode Attack \t\t: "),
        print("%5s" % attack_stat[8]),
        print("\t"),
        print("%.2f " % (float(attack_stat[8])/total_counter*100)),
        print("%")
        print("  Critical Condition Attacks \t: "),
        print("%5s" % attack_stat[9]),
        print("\t"),
        print("%.2f " % (float(attack_stat[9])/total_counter*100)),
        print("%")
        print("  Bad CRC Attack \t\t: "),
        print("%5s" % attack_stat[10]),
        print("\t"),
        print("%.2f " % (float(attack_stat[10])/total_counter*100)),
        print("%")
        print("  Clean Registers Attack \t: "),
        print("%5s" % attack_stat[11]),
        print("\t"),
        print("%.2f " % (float(attack_stat[11])/total_counter*100)),
        print("%")
        print("  Device Scan Attack \t\t: "),
        print("%5s" % attack_stat[12]),
        print("\t"),
        print("%.2f " % (float(attack_stat[12])/total_counter*100)),
        print("%")
        print("  Force Listen Attack \t\t: "),
        print("%5s" % attack_stat[13]),
        print("\t"),
        print("%.2f " % (float(attack_stat[13])/total_counter*100)),
        print("%")
        print("  Restart Attack \t\t: "),
        print("%5s" % attack_stat[14]),
        print("\t"),
        print("%.2f " % (float(attack_stat[14])/total_counter*100)),
        print("%")
        print("  Read Id Attack \t\t: "),
        print("%5s" % attack_stat[15]),
        print("\t"),
        print("%.2f " % (float(attack_stat[15])/total_counter*100)),
        print("%")
        print("  Function Code Scan Attack \t: "),
        print("%5s" % attack_stat[16]),
        print("\t"),
        print("%.2f " % (float(attack_stat[16])/total_counter*100)),
        print("%")
        print("  Rise/Fall Attacks \t\t: "),
        print("%5s" % attack_stat[17]),
        print("\t"),
        print("%.2f " % (float(attack_stat[17])/total_counter*100)),
        print("%")
        print("  Slope Attacks \t\t: "),
        print("%5s" % attack_stat[18]),
        print("\t"),
        print("%.2f " % (float(attack_stat[18])/total_counter*100)),
        print("%")
        print("  Random Value Attacks \t\t: "),
        print("%5s" % attack_stat[19]),
        print("\t"),
        print("%.2f " % (float(attack_stat[19])/total_counter*100)),
        print("%")
        print("  Negative Pressure Attack \t: "),
        print("%5s" % attack_stat[20]),
        print("\t"),
        print("%.2f " % (float(attack_stat[20])/total_counter*100)),
        print("%")
        print("  Fast Attacks \t\t\t: "),
        print("%5s" % attack_stat[21]),
        print("\t"),
        print("%.2f " % (float(attack_stat[21])/total_counter*100)),
        print("%")
        print("  Slow Attack \t\t\t: "),
        print("%5s" % attack_stat[22]),
        print("\t"),
        print("%.2f " % (float(attack_stat[22])/total_counter*100)),
        print("%")
        print("---------------------------------------------------------")
        print("  Total Number of Attacks \t: "),
        print("%5s" % sum(attack_stat.values()))
        print("---------------------------------------------------------")
        print("  Total MODBUS Packets \t\t: "),
